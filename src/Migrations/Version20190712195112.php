 ...
 */
final class Version20190712195112 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE employer (id INT AUTO_INCREMENT NOT NULL, service_id INT DEFAULT NULL, matricule VARCHAR(255) NOT NULL, nomcomplet VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, datenais DATE NOT NULL, salaire INT NOT NULL, INDEX IDX_DE4CF066ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
